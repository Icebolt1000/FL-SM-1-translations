translate portuguese strings:
    ...
    new "Você trocará para o Modo VN\nSeu progresso será mantido\n\nIsso não é recomendado, pode acabar introduzindo erros ou falhas"
